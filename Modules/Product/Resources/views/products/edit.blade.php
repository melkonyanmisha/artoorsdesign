...
{{--                                            </div>--}}
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                ...
                                                <textarea class="summernote" name="description_guest">{{ $product->description_guest }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="main-title d-flex">
                                                <h3 class="mb-3 mr-30">{{ __('product.specifications') }} Guest</h3>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">

                                            <textarea class="summernote summernote3" id="specification_guest"
                                                      name="specification_guest">{{ $product->specification_guest }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                ...
                                                <textarea style="height: 250px;" class="primary_input_field" name="scheme_markup"
                                                       placeholder="Scheme Markup">{{ $product->scheme_markup }}</textarea>
                            ...
                            <div class="col-lg-4">
                                <div class="white_box p-15 box_shadow_white pt-0">
                                    ...
                                    <div class="row">
                                        3D model format
                                        @php
                                            if($product->sellerProducts[0]->file_type){
                                                $a = explode(',',$product->sellerProducts[0]->file_type);
                                            }
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" @if(isset($a[0]) && ($a[0] == 1)) checked @endif  id="inlineCheckbox1" value="1" name="file_type[]">
                                            <label class="form-check-label" for="inlineCheckbox1">3DM</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" @if(isset($a[0]) && $a[0] == 2) checked @endif
                                            @if(isset($a[1]) && $a[1] == 2) checked @endif
                                            type="checkbox" id="inlineCheckbox2" value="2" name="file_type[]">
                                            <label class="form-check-label" for="inlineCheckbox2">STL</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input"
                                                   @if(isset($a[0]) && $a[0] == 3) checked @endif
                                                   @if(isset($a[1]) && $a[1] == 3) checked @endif
                                                   @if(isset($a[2]) && $a[2] == 3) checked @endif
                                                   type="checkbox" id="inlineCheckbox3" value="3" name="file_type[]" >
...
{{--                                                           placeholder="Upload Files" readonly="">--}}
{{--                                                    <button class="" type="button">--}}
...
{{--                                                        <label class="primary_input_label" for="">--}}
{{--                                                            file link</label>--}}
{{--                                                        <input class="primary_input_field" name="pdf_file"--}}
{{--                                                               placeholder="File Link" type="text"--}}
...
{{--    $.post('/iceDrive/login')--}}
{{--        .done(function (data){--}}
{{--            document.cookie = 'ice_drive_cookie ' + "=" + data.token;--}}
{{--            console.log(data)--}}
{{--        })--}}
{{--    $.get('/iceDrive/user/data')--}}
{{--</script>--}}
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('.image_selected_files').click(function (){
                addImageAlts();
            });
            ...
            function addImageAlts(){
                ...
                array.push('{{$product->images_alt}}'.split(','));
                valuesArray[0].reverse();

                for (let i = 1; i <= valuesArray[0].length; i++){
                    $('.images_alt').append('<div class="col-lg-12 val_' + i + '"><div class="primary_input mb-15"><label class="primary_input_label" for="">{{ __('common.image_alt') }} ' + i +'</label><input class="primary_input_field" name="images_alt[]" placeholder="{{ __('common.image_alt') }}" type="text" value="'+ array[0][i - 1] +'"></div></div>');
                }
            }
        });
    </script>
