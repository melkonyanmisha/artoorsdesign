            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    <div class="md-form mb-5">
                        <label data-error="wrong" data-success="right" for="defaultForm-email">{{ __('product.discount') }}</label>
                    ...
                    <div class="md-form mb-4">
                        <label data-error="wrong" data-success="right" for="defaultForm-pass">{{ __('product.discount_type')}}</label>
        ...
        (function($){
            ...
            $(document).ready(function(){
                ...
                var columnData = [
                    ...
                    { data: 'created_at', name: 'created_at',render: function (data, type, row) {//data
            ...
            $(document).on('click', '.delete_sku', function(event){
                ...
                @php
                    if(session()->get('name') && session()->get('name') == 'Name')
                        $name = 4;
                    elseif(session()->get('name') && session()->get('name') == 'PRICE')
                        $name = 2;
                    elseif(session()->get('name') && session()->get('name') == 'Дата')
                        $name = 4;
                    else
                        $name = 4;
