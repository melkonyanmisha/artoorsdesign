        ...
        (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.edit_category', function(event){
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            @if(isset($category))
                                $('#description').summernote('code', '{{$category->description}}');
                                $('#meta_description').summernote('code', '{{$category->meta_description}}');
                            @endif
                        },
                        error: function(response) {
                ...
                function showValidationErrors(formType, errors) {
                    ...
                    $(formType +' #error_title').text(errors.image);
                    $(formType +' #error_description').text(errors.description);
                    $(formType +' #error_meta_title').text(errors.meta_title);
                    $(formType +' #error_meta_description').text(errors.meta_description);
                    $(formType +' #error_meta_keyword').text(errors.meta_keyword);
                    $(formType +' #error_meta_image').text(errors.meta_image);
                    $(formType +' #error_meta_image_alt').text(errors.meta_image_alt);
                }
