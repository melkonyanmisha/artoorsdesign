...
<style>
    #category_edit_form .thumb_img_div #ThumbnailImg {
        width: 100%;
    }
    .thumb_img_div {
        display: block;
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <input class="primary_input_field title" type="text" id="title" name="title" autocomplete="off" value="{{$category->title}}" placeholder="{{__('common.title')}}">
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <textarea class="primary_input_field description" type="text" id="description" name="description" autocomplete="off" placeholder="{{__('common.description')}}">{{$category->description}}</textarea>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <input class="primary_input_field meta_title" type="text" id="meta_title" name="meta_title" value="{{$category->meta_title}}" autocomplete="off" placeholder="{{__('common.meta_title')}}">
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <textarea style="padding: 15px; height: 250px" class="primary_input_field meta_description" type="text" id="meta_description" name="meta_description" autocomplete="off" placeholder="{{__('common.meta_description')}}">{{$category->meta_description}}</textarea>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-25">
                        ...
                        <input class="primary_input_field meta_keyword" type="text" id="meta_keyword" name="meta_keyword" value="{{$category->meta_keyword}}" autocomplete="off" placeholder="Meta keyword">
                    </div>
                    ...
                    <div class="primary_input mb-25">
                        ...
                        <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="false" data-type="image" data-name="meta_image">
                            ...
                            <button class="" type="button">
                                ...
                                <input type="hidden" class="selected_files" value="{{$category->media_id}}">
                            </button>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="primary_input mb-15">
                        ...
                        <textarea style="height: 250px;" class="primary_input_field" name="scheme_markup"
                                  placeholder="Scheme Markup">{{ $category->scheme_markup }}</textarea>
