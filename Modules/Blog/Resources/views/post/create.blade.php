                        ...
                        <div class="col-lg-9">
                            <div class="white_box_25px box_shadow_white mb-20">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-25">
                                            ...
                                            <input name="title" class="primary_input_field title" id="title"
                                                   placeholder="{{ __('common.title') }}" type="text" autocomplete="off"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-25">
                                            <label class="primary_input_label" for="">{{__('common.slug')}} <span
                                                        class="text-danger">*</span></label>
                                            <input type="text" class="primary_input_field title" id="slug" name="slug"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field" name="meta_keywords"
                                                   placeholder="Meta keywords" type="text"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <textarea id="scheme_markup" style="height: 250px;"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <textarea id="laraberg" name="content" hidden
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="tagInput_field mb_26">
                                            <input name="tag" class="tag-input" id="tag-input-upload-shots" type="text"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="main-title d-flex">
                                            <label class="mb-2 mr-30">{{ __('common.image') }}
                                                <small>(1000x500)px</small></label>
                                        </div>
                                            ...
                                            <div class="primary_file_uploader">
                                                ...
                                                <button class="" type="button">
                                                    <label class="primary-btn small fix-gr-bg"
                                                           for="document_file_1">{{__("common.image")}} </label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for=""> {{ __('common.image_alt')}}</label>
                                            <input class="primary_input_field" name="image_alt"
                                                   placeholder="{{ __('common.image_alt') }}" type="text"
                                                   value="{{ old('image_alt') }}">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-12">
                                            <input type="checkbox" id="comments" class="filled-in" name="comments"
                                                   value="0">
