                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <textarea class="primary_textarea height_112 meta_description"
                                                  ...
                                                  name="meta_description" spellcheck="false">{{ old('meta_description') ?? $post->meta_description }}</textarea>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <textarea style="height: 250px;" class="primary_input_field" name="scheme_markup"
                                                  placeholder="Scheme Markup">{{ $post->scheme_markup }}</textarea>
...
{{--                                </div>--}}
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label" for=""> {{ __('common.image_alt')}}</label>
