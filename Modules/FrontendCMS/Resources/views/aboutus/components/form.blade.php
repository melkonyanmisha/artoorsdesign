    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="primary_input mb-25">
                        <label class="primary_input_label" for="">{{__('frontendCms.home_page_title')}} <span class="text-danger">*</span></label>
                        <input name="home_page_title" class="primary_input_field" placeholder="-" type="text"
                               value="{{ old('home_page_title')? old('home_page_title'):$aboutus->home_page_title }}">
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            <label class="primary_input_label" for="">{{__('frontendCms.home_page_description')}} <span class="text-danger">*</span></label>
                            <textarea name="home_page_description"
                                      class="lms_summernote summernote4">{{ $aboutus->home_page_description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
