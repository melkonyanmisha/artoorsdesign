...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-20 white_box">
            <form action="{{route('update.contact-us-seo',['id' => $info->id])}}" method="POST" enctype="multipart/form-data"
                  id="choice_form">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-12">
                        <div class="box_header common_table_header">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">Edit Message Page SEO</h3>
                            </div>
                        </div>
                    </div>
                </div>
