                ...
                <div class="mb-10">
                    <div class="card" id="accordion_{{$element->id}}">
                        <div class="card-header card_header_element">
                            ...
                            <div class="pull-right">
                                <td style=""><label class="switch_toggle" for="checkbox_all_product_{{$element->id}}">
                                        <input type="checkbox" id="checkbox_all_product_{{$element->id}}" @if($element->status) checked @endif value="" data-id="{{$element->id}}" class="header_status_change">
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" id="element_edit_form">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">{{ __('appearance.slider_image') }} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="name">{{__('common.image_alt')}} <span class="text-danger">*</span></label>
                                                <input class="primary_input_field" type="text" id="image_alt" name="image_alt" autocomplete="off"
                                                       value="{{$element->image_alt}}" placeholder="{{__('common.image_alt')}}" required>
                                            </div>
                                            <span class="text-danger" id="error_image_alt"></span>
                                        </div>
