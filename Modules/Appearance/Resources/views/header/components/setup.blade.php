...
{{--                        </li>--}}
                        <li class="nav-item">
                            <a class="nav-link active show" href="#Setup" role="tab" data-toggle="tab" id="2"
...
{{--        <div role="tabpanel" class="tab-pane fade " id="GeneralSeting">--}}
{{--            <div class="container-fluid p-0">--}}
{{--                <div class="row">--}}
...
<script>
    (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('change', '.header_status_change', function(event){
                    let status = 0;
                    ...
                    $.ajax({
                        url: "{{ route('appearance.update.status1') }}",
                        type: "post",
                        cache: false,
                        contentType: false,
                        processData: false,
