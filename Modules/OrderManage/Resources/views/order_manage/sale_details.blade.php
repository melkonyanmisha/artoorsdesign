...
{{--                                                <td>: {{ @$order->address->billing_city_id}}</td>--}}
{{--                                            </tr>--}}
{{--                                            <tr>--}}
{{--                                                <td>{{__('common.state')}}</td>--}}
{{--                                                <td>: {{ @$order->address->billing_state_id }}</td>--}}
{{--                                            </tr>--}}
                                            <tr>
                                                <td>{{__('common.country')}}</td>
                                                <td>: {{ @$order->address->billing_country_id }}</td>
                                            </tr>
{{--                                            <tr>--}}
...
{{--                                            <tr>--}}
{{--                                                <td>{{__('common.city')}}</td>--}}
{{--                                                <td>: {{ $order->guest_info->billing_city_id}}</td>--}}
{{--                                            </tr>--}}
{{--                                            <tr>--}}
{{--                                                <td>{{__('common.state')}}</td>--}}
{{--                                                <td>: {{ @$order->guest_info->billing_state_id }}</td>--}}
{{--                                            </tr>--}}
                                            <tr>
                                                <td>{{__('common.country')}}</td>
                                                <td>: {{ @$order->guest_info->billing_country_id }}</td>
                                            </tr>
                                            <tr>
                                        </table>
                                    </div>
