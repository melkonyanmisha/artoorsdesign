...
<section class="mb-40">
    <div class="container-fluid p-0">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                <div class="float-md-right float-none pos_tab_btn justify-content-end">
                    <ul class="nav">
                        ...
                        <li class="nav-item mb_5">
                            <a class="nav-link filtering week" data-type="week" href="javascript:void(0)">{{
                                __('dashboard.this_week') }}</a>
                        </li>
                        <li class="nav-item mb_5">
                            <a class="nav-link filtering month" data-type="month" href="javascript:void(0)">{{
                                __('dashboard.this_month') }}</a>
                        </li>
                        <li class="nav-item mb_5">
                            <a class="nav-link filtering year" data-type="year" href="javascript:void(0)">{{
        ...
        <div class="row mb_30">
            ...
            permissionCheck('widget_total_sale') && auth()->check() && auth()->user()->role->type != "admin")
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                <div
...
{{--            @endif--}}
            ...
            permissionCheck('widget_total_revenue') && auth()->check() && auth()->user()->role->type != "admin")
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                <div
                            ...
                            <div class="">
                                <table class="table Crm_table_active4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$key + 1}}</td>
                                            <td><a href="{{singleProductURL($product->seller->slug, $product->slug, $product->product->categories[0]->slug)}}"
...
<script>
    ...
    $(document).ready(function (){
        if('{{session()->get('dash')}}'){
            $('.{{session()->get('dash')}}').click()
        }
    })

    $('.filtering').click(function (){
        $.get('/session/set',{'type' : $(this).attr('data-type')})
    })
</script>
