...
@else
    @section('title')
        {{"Search Result $slug | Artoors Designe"}}
    @endsection
    @section('share_meta')

        <meta name="title" content="{{$slug}}"/>
        <meta name="description"
              content="Get the best results about 3d Modelings when you search with us. Our powerful search engine quickly finds what you're looking for and provides accurate, comprehensive results. Get started now and find the best matches for {{$slug}}"/>
                        ...
                        <div class="category_about_us_section d_flex">
                            <div class="d_flex sto_">
                                @if(str_contains("page", request()->url()) && isset($_GET['page']))
                                    <h1 style="font-size: 25px; margin-bottom: 15px">
                                        Search Result {{$slug}} – Page {{$_GET['page']}}
                                    </h1>
                                @else
                                    <h1 style="font-size: 25px; margin-bottom: 15px">
                                        Search Result {{$slug}} – Page 1
                                    </h1>
                                @endif
                            </div>
                            <div class="category_about_us" style="width: 100%">
                                <p style="text-align: justify">
                                    Here you will find the best matches for your {{$slug}}
                                    quickly & easily! Our leading search engine technology allows you to discover and
                                    explore the best content on the Artoors Design website, tailored specifically to
                                    your needs. With powerful filters and advanced search tools, never miss out on
