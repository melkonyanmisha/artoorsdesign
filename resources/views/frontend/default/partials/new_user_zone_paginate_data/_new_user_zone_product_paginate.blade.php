          ...
          <div class="single_product_list product_tricker">
            <div class="product_img">
              ...
              <div class="socal_icon">
                ...
                <a class="{{ $disabledAddToCartClass }} addToCartFromThumnail" data-producttype="{{ @$product->product->product->product_type }}" data-seller={{ @$product->product->user_id }} data-product-sku={{ @$product->product->skus->first()->id }}
