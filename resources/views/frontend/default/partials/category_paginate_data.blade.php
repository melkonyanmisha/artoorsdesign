...
{{--                                {{ substr($product->product_name,0,28) }} --}}
{{--                            @if(strlen($product->product_name) > 28)--}}
{{--                                 @endif --}}
{{--                            @else {{substr(@$product->product->product_name,0,28)}} --}}
{{--                            @if(strlen(@$product->product->product_name) > 28)--}}
{{--                                 @endif --}}
                            @else
...
@endauth
        @else
            ...
            @endphp
                       ...
                       @else class="{{$disabledAddToCartClass}} add_catalog_btn login_btn" @endauth
        @endif
...
{{--        <div class='choose_pagination_quantity d_flex'> <span> Per page: </span> <a href="{{route('frontend.category',['paginate_id'=>12])}}">12</a> <a--}}
{{--                    href="{{route('frontend.category',['paginate_id'=>24])}}">24</a> <a--}}
{{--                    href="{{route('frontend.category',['paginate_id'=>36])}}">36</a> <a--}}
{{--                    href="{{route('frontend.category',['paginate_id'=>72])}}">72</a> <a--}}
{{--                    href="{{route('frontend.category',['paginate_id'=>144])}}">144</a>  </div>--}}

{{--        <div class="d_flex pagination_block">--}}
{{--            <a  data-href=" {{$products->previousPageUrl() }} " class="category_paginate @if($products->currentPage() != 1) getFilterUpdateByIndex @endif prev_next_page">--}}
{{--                <svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
{{--                    <path d="M8 1.25L2 7.25L8 13.25" stroke="#282828" stroke-width="2.25"/>--}}
{{--                </svg>--}}
{{--            </a>--}}
{{--            @if($products->lastPage() > 1)--}}
{{--                <a data-href=" {{ $products->url(1) }}" class="category_paginate getFilterUpdateByIndex pagination_sp @if($products->currentPage() == 1) pagination_sp_active @endif">1</a>--}}
{{--            @endif--}}
{{--            @if($products->lastPage() > 2)--}}
{{--                <a data-href=" {{$products->url(2) }}" class="category_paginate getFilterUpdateByIndex pagination_sp @if($products->currentPage() == 2) pagination_sp_active @endif">2</a>--}}
{{--            @endif--}}
{{--            @if($products->lastPage() > 3)--}}
{{--                <a  data-href=" {{$products->url(3) }}" class="category_paginate getFilterUpdateByIndex pagination_sp @if($products->currentPage() == 3) pagination_sp_active @endif">3</a>--}}
{{--            @endif--}}
{{--            @if( $products->lastPage() > 4)--}}
{{--                <a>...</a>--}}
{{--            @endif--}}
{{--            <a data-href=" {{$products->url($products->lastPage()) }}" class="category_paginate getFilterUpdateByIndex pagination_sp  @if($products->currentPage() == $products->lastPage()) pagination_sp_active @endif">{{ $products->lastPage() }}</a>--}}
{{--            <a  data-href=" {{$products->nextPageUrl()  }}" class="category_paginate @if($products->currentPage() != $products->lastPage()) getFilterUpdateByIndex @endif prev_next_page">--}}
{{--                <svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
