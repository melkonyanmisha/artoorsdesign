...
if (!function_exists('singleProductURL')) {
    function singleProductURL($seller = null, $product, $category = null){
        if(isModuleActive('MultiVendor')){
            return route('frontend.item.show',[$category, $seller, $product]);
        }else{
            return route('frontend.item.show',[$category, $product]);
        }
    }
}
