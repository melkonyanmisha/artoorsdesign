...
class Order extends Model
{
    ...
    public function status(){
        if($this->is_confirmed == 0 && $this->is_cancelled == 0){
            return 'Pending';
        }elseif($this->is_confirmed == 1 && $this->is_cancelled == 0 && $this->is_completed == 0){
            return 'Confirmed';
        }elseif($this->is_confirmed == 1 && $this->is_cancelled == 0){
            return 'Completed';
        }elseif($this->is_paid == 0 && $this->is_cancelled == 0){
            return 'Pending Payment';
        }elseif($this->is_cancelled == 1){
            return 'Canceled';
        }
