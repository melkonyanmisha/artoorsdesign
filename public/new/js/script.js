...
$('.notif_fav .head_icons_svg').click(function () {
    ...
    $('.container').on('mousemove', function (event) {
        removeActiveClass('notif_fav', 'for_notifications_active', event);
    });
});
...
$('.sort_by').on('click', function () {
    ...
    $('.container').on('mousemove', function (event) {
        removeActiveClass('sort_by', 'sorts_drpdwn_active', event);
    });
});
...
$('.head_catal .head_icons_svg').on('click', function () {
    ...
    $('.container').on('mousemove', function (event) {
        removeActiveClass('head_catal', 'for_catal_active', event);
    });
})

function removeActiveClass(parentElementClassName, childElementClassName, event) {
    const parentElement = $(`.${parentElementClassName}`);
    const childElement = $(`.${childElementClassName}`);
    ...
    if (
        ...
        $(childElement).removeClass(childElementClassName);
    }
}
